...
class SortingVisualizerApp:
    def __init__(self, root):
        ...
        self.generate_button = ttk.Button(self.control_frame, text="Generate Array", command=self.generate_array)
    ...
    def generate_array(self):
        if not self.manual_input_var.get():
            ...
            while len(unique_numbers) < size:
                unique_numbers.add(random.randint(0, 1000))  # Add unique random numbers between 0 and 100000
